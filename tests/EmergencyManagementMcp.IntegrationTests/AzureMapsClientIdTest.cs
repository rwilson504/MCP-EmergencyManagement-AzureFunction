...
namespace EmergencyManagementMcp.IntegrationTests
{
    ...
    public class AzureMapsClientIdTest
    {
        ...
        public void Configuration_Keys_Should_Be_Documented()
        {
            ...
            _output.WriteLine("  Maps:ClientId = maps.outputs.clientId (Azure Maps uniqueId property)");
            _output.WriteLine("  AzureWebJobsStorage:clientId = managed identity client ID");
            _output.WriteLine("");
        ...
        public void Verify_Bicep_Output_Maps_Client_Id()
        {
            ...
            _output.WriteLine("  - Added: Maps:ClientId: maps.outputs.clientId to appSettings");
            _output.WriteLine("");
